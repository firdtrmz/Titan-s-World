...
public class DoublyLinkedListEV<E> {
    private Node2<E> head;

    private Node2<E> tail;
    private int size;

    public DoublyLinkedListEV() {
        size = 0;
        this.head = null;
        this.tail = null;
    }
    ...
    public void addFirst(E element) {
        ...
        Node2<E> tmp = new Node2(element, head, null);
    ...
    public void addLast(E element) {
        ...
        Node2<E> tmp = new Node2(element, null, tail);
    ...
    public void add(int index, E element) {
        if (index == 0) {
            ...
            Node2<E> temp = current.next;
            current.next = new Node2<E>(element);
